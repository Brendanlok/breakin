-- [04/04] Breakin — competitive mode: sync each player's arena so the opponent can watch it fill.
-- Run after 03-rooms.sql (adds columns to breakin_rooms).
...
-- existing ~900ms tick. Safe to run more than once.
--
